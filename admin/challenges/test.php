    ...
    <div id="top">
      ...
      <div id="usermenu">
        <div style="float:right">
          ...
          <button onclick="usermenu()" class="dropbtn"><img src="../../img/<?php echo $settingBTN; ?>" style="height: 25px;"></button>
        </div>
        <div class="dropdown">
  ...
  <div id="content">
    <div style="display: flex; justify-content: space-between;">
      ...
      <form action="./view.php" method="get" style="margin: 25px 25px 0px 0px;">
        ...
        <input type="text" name="search" id="searchInput" placeholder="Search challenges...">
      ...
      <?php
        if (isset($_GET['idctf'])) {
          ...
          if ($result->num_rows > 0) {
            ...
            echo"<a id='showHint'>Show Hint</a>";
            echo"</div>";

            echo "<div>";
              echo "<form action='' method='post' style=''>";
              echo "  <input type='text' name='key' id='keyInput' value='' placeholder='Enter the key...'>";
              ...
              if (isset($_POST['key'])) {
                if($_POST['key'] == $row['keyfile']){
                  ...
                  echo "<script>document.getElementById('keyInput').disabled = true;</script>";
            ...
            echo "<form action='./view.php' method='get' style='float: right;'>";  // Added form
              echo "  <input id='cancelBTN' type='submit' style='font-size: 1.3rem; padding: 7px 12px 7px 12px;' value='Close'>";
            echo "</form>";
            echo "</div>";
          } 
          else 

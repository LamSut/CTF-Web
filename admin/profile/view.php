...
<body>
  ...
  <div id="content" style="margin-top:160px">
    <div style="float: left; width: 30%; margin-left:10px">
      ...
      <h3 style="margin: 21px 0px 14px 0px;"><?php echo $_SESSION['name']; ?></h3>
      <h4 style="margin: 0px 0px 7px 0px; font-weight:normal"> <?php echo $_SESSION['idacc'] ?> - <?php echo $gender === 1 ? "He/Him" : "She/Her" ?></h4>
      <h5 style="margin: 0px 0px 7px 0px; font-weight:normal"> <?php echo $email?> </h5>
    </div>
